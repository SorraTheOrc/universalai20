...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Changes The Pet AI's Behaviour (Follow, Stay)")]
	public class SetPetAIBehaviour : FsmStateAction
	{
		...
		public PetBehaviour newBehaviour;
		...
		public void Execute()
		{
			AICommandManager.PetCommands.ChangePetBehaviour(newBehaviour);
		}
