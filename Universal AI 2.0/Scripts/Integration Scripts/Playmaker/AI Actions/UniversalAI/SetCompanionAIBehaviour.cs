...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Changes The Companion AI's Behaviour (Follow, Stay)")]
	public class SetCompanionAIBehaviour : FsmStateAction
	{
		...
		[Tooltip("The New Behaviour For The Companion AI.")]
		public CompanionBehaviour newBehaviour;
		...
		public void Execute()
		{
			AICommandManager.CompanionCommands.ChangeCompanionBehaviour(newBehaviour);
		}
