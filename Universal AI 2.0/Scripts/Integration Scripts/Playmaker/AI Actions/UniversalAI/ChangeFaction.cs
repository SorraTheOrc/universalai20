...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Changes The AI's Current Faction.")]
	public class ChangeFaction : FsmStateAction
	{
		...
		[Tooltip("The New Faction For The AI.")]
		public UniversalAIEnums.Factions NewFaction;
		...
		public void Execute()
		{
			AICommandManager.ChangeFaction(NewFaction);
		}
