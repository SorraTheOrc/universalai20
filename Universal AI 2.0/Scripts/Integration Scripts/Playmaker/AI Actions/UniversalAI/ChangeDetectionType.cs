...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Changes The AI's Current Detection Type.")]
	public class ChangeDetectionType : FsmStateAction
	{
		...
		[Tooltip("The New Detection Type For The AI.")]
		public UniversalAIEnums.DetectionType NewDetectionType;
		...
		public void Execute()
		{
			AICommandManager.ChangeDetectionType(NewDetectionType);
		}
