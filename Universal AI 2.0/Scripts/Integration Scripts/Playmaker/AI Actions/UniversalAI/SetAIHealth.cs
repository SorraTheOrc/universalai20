...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Sets The AI Health Instantly.")]
	public class SetAIHealth : FsmStateAction
	{
		...
		[Tooltip("The AI's New Health.")]
		[Space] public FsmFloat NewHealthAmount = 0f;
		...
		public void Execute()
		{
			AICommandManager.SetAIHealth(NewHealthAmount.Value);
		}
