...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Changes The AI's Wandering Type.")]
	public class ChangeAIWanderType : FsmStateAction
	{
		...
		[Tooltip("The New Wander Type For The AI.")]
		public UniversalAIEnums.WanderType NewWanderTypeType;
		...
		public void Execute()
		{
			AICommandManager.ChangeAIWanderType(NewWanderTypeType);
		}
