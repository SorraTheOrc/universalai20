			...
			if (array != null && array.isArray) {
				...
				if (!lists.TryGetValue(id, out list)) {
					...
					if (attrib != null) {
						...
						list = new ReorderableList(array, attrib.add, attrib.remove, attrib.draggable, displayType, attrib.elementNameProperty, attrib.elementNameOverride, icon,attrib.Limit);
