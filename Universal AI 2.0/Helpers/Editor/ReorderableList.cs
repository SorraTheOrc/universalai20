...
namespace UniversalAI
{
	...
	public class ReorderableList {
		...
		public ReorderableList(SerializedProperty list)
			: this(list, true, true, true,true) {
		}

		public ReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, bool Limit = true)
			: this(list, canAdd, canRemove, draggable, ElementDisplayType.Auto, null, null, null,Limit) {
		}

		public ReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, Texture elementIcon, bool Limit = true)
			: this(list, canAdd, canRemove, draggable, elementDisplayType, elementNameProperty, null, elementIcon,Limit) {
		}

		public ReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, string elementNameOverride, Texture elementIcon, bool Limit = true) {
